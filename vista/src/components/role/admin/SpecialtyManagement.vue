    ...
    <div class="admin-page">
      ...
      <div class="table-card">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="s in specialtyStore.specialties" :key="s.id">
              <td>{{ s.name }}</td>
              <td>
                <button class="btn btn-secondary" @click="openModal(s)">
                  Editar
                </button>
        ...
        <div class="modal">
          ...
          <form @submit.prevent="save">
            <div class="form-group">
              ...
              <input v-model="form.name" type="text" placeholder="Ej. Cardiología" required />
            </div>
